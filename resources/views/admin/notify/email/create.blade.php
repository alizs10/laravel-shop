...
@section('head-tag')
    <title>پنل ادمین | بخش محتوی | اطلاعیه ایمیلی جدید</title>
...
@section('breadcrumb')
    <section class="m-2 px-2 py-4 rounded-lg bg-slate-100 dark:bg-slate-800 dark:text-white flex items-center gap-x-2">
        ...
        <i class="fa-light fa-angles-left text-xs md:text-sm"></i>
        <span class="text-xs md:text-base">اطلاعیه ایمیلی جدید</span>
...
@section('content')
    <section class="flex flex-col gap-y-2 p-2 w-full">
        ...
        <form class="w-full" action="{{ route('admin.notify.email.store') }}" method="POST"
            ...
            <section class="w-full grid grid-cols-2 gap-2">
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    <label for="subject"
                        ...
                        ایمیل</label>
                    <input type="text" class="form-input" name="subject" id="subject" value="{{ old('subject') }}">
                </div>
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
