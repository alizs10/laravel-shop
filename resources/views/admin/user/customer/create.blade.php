...
@section('head-tag')
    <title>پنل ادمین | بخش کاربران | ایجاد مشتری</title>
@endsection
...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.user.customer.store') }}" method="POST" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row-head">
