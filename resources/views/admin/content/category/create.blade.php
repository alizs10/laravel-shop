...
@section('head-tag')
    ...
    <title>پنل ادمین | بخش محتوی | دسته بندی ها | ایجاد دسته بندی جدید</title>
@endsection
@section('breadcrumb')
...
@section('content')
    <section class="flex flex-col gap-y-2 p-2 w-full">
        ...
        <form class="w-full" action="{{ route('admin.content.category.store') }}" method="POST"
            ...
            <section class="w-full grid grid-cols-2 gap-2">
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    <label for="name"
                        class="text-xs {{ $errors->has('name') ? 'text-red-600 dark:text-red-400' : '' }}">نام دسته</label>
                ...
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    ...
                    <input type="text" class="form-input" name="description" id="description" value="{{ old('description') }}">
                </div>
