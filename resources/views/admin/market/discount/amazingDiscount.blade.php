...
<section class="flex flex-col gap-y-2 p-2 w-full">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.market.discount.amazing.create') }}" class="btn bg-blue-600 text-white">ایجاد تخفیف شگفت انگیز
            جدید</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="flex items-center gap-x-1">
                                ...
                                <form class="m-0"
                                action="{{ route('admin.market.discount.amazing.destroy', $discount->id) }}" method="POST">
                                    @csrf
                                    {{ method_field('delete') }}
