...
@section('head-tag')
    <title>پنل ادمین | بخش اطلاع رسانی | ویرایش اطلاعیه پیامکی جدید</title>
...
@section('breadcrumb')
    <section class="m-2 px-2 py-4 rounded-lg bg-slate-100 dark:bg-slate-800 dark:text-white flex items-center gap-x-2">
        ...
        <i class="fa-light fa-angles-left text-xs md:text-sm"></i>
        <span class="text-xs md:text-base">ویرایش اطلاعیه پیامکی جدید</span>
...
@section('content')
    <section class="flex flex-col gap-y-2 p-2 w-full">
        ...
        <div class="flex justify-between items-center">
            <span class="text-sm md:text-lg">ویرایش اطلاعیه پیامکی جدید</span>
        ...
        <form class="w-full" action="{{ route('admin.notify.sms.update', $sms->id) }}" method="POST"
            ...
            <section class="w-full grid grid-cols-2 gap-2">
                ...
                <div class="col-span-2 flex flex-col gap-y-1">
                    <label for="body"
                        ...
                        پیامک</label>
                    <textarea rows="6" class="form-input" name="body" id="body">{{ old('body', $sms->body) }}</textarea>
                </div>
