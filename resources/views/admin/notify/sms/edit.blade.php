...
@section('head-tag')
    <title>پنل ادمین | بخش محتوی | ویرایش اطلاعیه پیامکی</title>
...
@section('content')
    <div class="box-container">
        <ol class="route-map-group">
            ...
            <li><a class="text-primary" href="{{ route('admin.notify.sms.index') }}">اطلاعیه پیامکی</a></li>/
            <li>ویرایش طلاعیه پیامکی</li>
        ...
        <form action="{{ route('admin.notify.sms.update', $sms->id) }}" method="POST" id="form">
            ...
            <div class="row-head">
                <div class="form-input-half">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $sms->title) }}">
                </div>
                ...
                <div class="form-input-half">
                    ...
                    <input type="hidden" name="published_at" value="{{ old('published_at', $sms->published_at) }}" id="published_at">
                    <input type="text" id="published_at_view" value="{{ old('published_at', $sms->published_at) }}">
                </div>
                ...
                <div class="form-input-full">
                    ...
                    <select name="status" id="status">
                        <option value="1" @if (old('status', $sms->status) == 1)
                            selected
                            @endif>فعال</option>
                        <option value="0" @if (old('status', $sms->status) == 0)
                            selected
                ...
                <div class="form-input-full">
                    ...
                    <textarea name="body" rows="6">{{ old('body', $sms->body) }}</textarea>
                </div>
