...
@section('head-tag')
    <title>پنل ادمین | بخش محتوی | ایجاد منوی جدید</title>
@endsection
@section('breadcrumb')
    <section class="m-2 px-2 py-4 rounded-lg bg-slate-100 dark:bg-slate-800 dark:text-white flex items-center gap-x-2">
        ...
        <i class="fa-light fa-angles-left text-xs md:text-sm"></i>
        <span class="text-xs md:text-base">ایجاد منوی جدید</span>
...
@section('content')
    <section class="flex flex-col gap-y-2 p-2 w-full">
        ...
        <div class="flex justify-between items-center">
            <span class="text-sm md:text-lg">ایجاد منو</span>
        ...
        <form class="w-full" action="{{ route('admin.content.menu.store') }}" method="POST"
            ...
            <section class="w-full grid grid-cols-2 gap-2">
                ...
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    ...
                    <input type="text" class="form-input" name="icon" id="icon" value="{{ old('icon') }}">
                </div>
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    <label for="url"
                ...
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    <label for="parent_id"
                        class="text-xs {{ $errors->has('parent_id') ? 'text-red-600 dark:text-red-400' : '' }}">منوی والد</label>
                ...
                <div class="col-span-2 md:col-span-1 flex flex-col gap-y-1">
                    ...
                    <input type="text" class="form-input" name="order_number" id="order_number" value="{{ old('order_number') }}">
                </div>
