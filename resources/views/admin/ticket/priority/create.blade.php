...
@section('content')
    <div class="box-container">
        <ol class="route-map-group">
            ...
            <li><a class="text-primary" href="{{ route('admin.ticket.priority.index') }}">اولویت بندی</a></li>/
            <li>ایجاد اولویت بندی جدید</li>
    ...
    <div class="box-container">
        <div class="row-head">
            <h2>اولویت بندی جدید</h2>
            <a href="{{ route('admin.ticket.priority.index') }}" class="button button-info">بازگشت</a>
        </div>
